...
class YfcasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create yfcase" do
    assert_difference('Yfcase.count') do
      post yfcases_url, params: { yfcase: { case_number: @yfcase.case_number, country_id: @yfcase.country_id, township_id: @yfcase.township_id, user_id: @yfcase.user_id } }
    end
  ...
  test "should update yfcase" do
    patch yfcase_url(@yfcase), params: { yfcase: { case_number: @yfcase.case_number, country_id: @yfcase.country_id, township_id: @yfcase.township_id, user_id: @yfcase.user_id } }
